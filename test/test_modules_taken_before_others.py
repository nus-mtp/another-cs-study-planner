...
class TestCode(object):
	...
	CONTENT_FORM_MODULEA = '<input type="text" name="moduleA", placeholder="Enter module'+\
                               ' code here" pattern="[a-zA-Z0-9\s]+" oninvalid="this.setCustomValidity(\'Module'+\
                               ' code must be alphanumeric and not empty\')" oninput="setCustomValidity(\'\')" required>'
	...
	CONTENT_BUTTON = '<input class="btn btn-primary" style="margin-top: 10px;" type="submit" value="Go">'
