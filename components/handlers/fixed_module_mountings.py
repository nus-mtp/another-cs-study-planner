...
class Fixed(object):
    ...
    def __init__(self):
        ...
        self.module_infos = model.get_all_modules()
        self.mounted_module_infos = model.get_all_fixed_mounted_modules()
        ...
        self.current_ay = self.mounted_module_infos[0][2]
    ...
    def populate_mounting_values(self):
        ...
        for info in self.mounted_module_infos:
            code = info[0]
    ...
    def GET(self):
        ...
        return RENDER.moduleMountingFixed(self.mounted_module_infos, self.current_ay,
                                          self.full_mounting_plan)
